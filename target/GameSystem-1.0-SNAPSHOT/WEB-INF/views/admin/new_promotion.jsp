                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <s:form method="POST" modelAttribute="promotion" action="${pageContext.request.contextPath}/manager/promotion/new" enctype="multipart/form-data">			
					              	...
					              	<div class="table-responsive">
					                	<div class="input-group mb-3">
					  						...
					  						<s:input path="url" class="form-control" />
										</div>
					              	</div>
		              	            <div class="input-group mb-3">
					  					<div class="input-group-prepend">
